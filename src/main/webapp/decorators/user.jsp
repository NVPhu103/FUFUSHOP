...
<body>
	...
	<div class="body-wrapper">
		...
		<header>
			...
			<%@ include file="/common/user/HeaderMiddle.jsp"%>
			<!-- Header Middle Area End Here -->
			
			<!-- Begin Header Bottom Area -->
			<%@ include file="/common/user/HeaderBottom.jsp"%>
			<!-- Header Bottom Area End Here -->
			
			<!-- Begin Mobile Menu Area -->
			<%@ include file="/common/user/MobileMenu.jsp"%>
		...
		<div class="footer">
			...
			<%@ include file = "/common/user/FooterTop.jsp" %>
			<!-- Footer Static Top Area End Here -->
			
			<!-- Begin Footer Static Middle Area -->
			<%@ include file = "/common/user/FooterMiddle.jsp" %>
			<!-- Footer Static Middle Area End Here -->
			
			<!-- Begin Footer Static Bottom Area -->
			<%@ include file = "/common/user/FooterBottom.jsp" %>
			<!-- Footer Static Bottom Area End Here -->
		</div>
		<!-- Footer Area End Here -->
		
		<!-- Begin Quick View | Modal Area -->
		<%@ include file = "/common/user/QuickView.jsp" %>
