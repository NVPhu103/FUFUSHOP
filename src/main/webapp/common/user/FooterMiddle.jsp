			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="footer-logo">
						...
						<p class="info">We are a team of designers and developers that
							create high quality HTML Template & Woocommerce, Shopify Theme.</p>
					</div>
					<ul class="des">
						<li><span>Address: </span> 6688Princess Road, London, Greater
							London BAS 23JK, UK</li>
					...
					<div class="footer-block">
						...
						<ul class="social-link">
							...
							<li class="google-plus"><a
								...
								data-toggle="tooltip" target="_blank" title="Google Plus"> <i
